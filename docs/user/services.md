...
Config.Env or Config.Label variable `SERVICE_EXPOSE_IPV6` to any non empty value:

        LABEL SERVICE_EXPOSE_IPV6="true"
        LABEL SERVICE_EXPOSE_IPV6="yes"
        ENV SERVICE_EXPOSE_IPV6="x"

All of the above will expose IPv6 address instead of IPv4. Where any of following
will still expose IPv4:

        LABEL SERVICE_EXPOSE_IPV6=""
        ENV SERVICE_EXPOSE_IPV6""
